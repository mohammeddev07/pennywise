...
class TransactionServiceTest {
  ...
  void create_savesAndReturnsEntity() {
    ...
    TransactionEntity result =
        service.create(book, category, TransactionType.EXPENSE, 3000L, occurredOn, "Lunch");
  ...
  void create_throwsBadRequest_whenAmountNonPositive() {
    ApiException ex =
        assertThrows(
            ...
            () ->
                service.create(
                    book, category, TransactionType.EXPENSE, 0L, LocalDate.of(2026, 1, 1), "x"));
  ...
  @Test
  void create_rejectsCategoryWhoseTypeDoesNotMatchTransaction() {
    ...
    assertEquals("Category type must match transaction type", ex.getMessage());
    assertEquals(HttpStatus.BAD_REQUEST, ex.status());
    verifyNoInteractions(repo, categoryRepo);
  }

  @Test
  void create_derivesOccurredOnInBookTimezoneFromOccurredAt() {
    book.setTimezone("America/Chicago");
    OffsetDateTime occurredAt = OffsetDateTime.parse("2026-02-01T04:30:00Z");
    when(repo.save(any(TransactionEntity.class)))
  ...
  @Test
  void create_rejectsInvalidBookTimezoneInsteadOfFallingBackToUtc() {
    book.setTimezone("Not/A_Timezone");
        ...
        assertThrows(
            ...
            () ->
                service.create(
                    ...
                    null,
                    null,
                    OffsetDateTime.parse("2026-02-01T04:30:00Z")));
  ...
  void update_updatesFieldsAndSaves() {
    ...
    TransactionUpdateRequest req =
        new TransactionUpdateRequest(
            TransactionType.INCOME, 9000L, LocalDate.of(2026, 1, 15), null, "Updated note");
  ...
  void update_throwsBadRequest_whenAmountNonPositive() {
    ...
    TransactionUpdateRequest req = new TransactionUpdateRequest(null, 0L, null, null, null);
  ...
  void update_changesCategory_whenProvidedAndFound() {
    ...
    newCat.setBook(book);
    newCat.setType(CategoryType.EXPENSE);

    when(categoryRepo.findByIdAndBook_IdAndDeletedAtIsNull(newCatId, bookId))
        .thenReturn(Optional.of(newCat));
    when(repo.save(existing)).thenReturn(existing);

    TransactionUpdateRequest req = new TransactionUpdateRequest(null, null, null, newCatId, null);
  ...
  @Test
  void update_rejectsTypeThatDoesNotMatchExistingCategory() {
    TransactionEntity existing =
        tx(txId, LocalDate.of(2026, 1, 1), OffsetDateTime.now(ZoneOffset.UTC));
    TransactionUpdateRequest req =
        new TransactionUpdateRequest(TransactionType.INCOME, null, null, null, null);
  ...
  @Test
  void update_rejectsCategoryThatDoesNotMatchExistingTransactionType() {
    TransactionEntity existing =
        tx(txId, LocalDate.of(2026, 1, 1), OffsetDateTime.now(ZoneOffset.UTC));
    UUID newCatId = UUID.fromString("dddddddd-dddd-dddd-dddd-dddddddddddd");
    CategoryEntity incomeCategory = new CategoryEntity();
    incomeCategory.setId(newCatId);
    incomeCategory.setBook(book);
  ...
  @Test
  void update_derivesOccurredOnInBookTimezoneFromOccurredAt() {
    book.setTimezone("America/Chicago");
    TransactionEntity existing =
        tx(txId, LocalDate.of(2026, 1, 1), OffsetDateTime.now(ZoneOffset.UTC));
    OffsetDateTime occurredAt = OffsetDateTime.parse("2026-02-01T04:30:00Z");
    TransactionUpdateRequest req =
        new TransactionUpdateRequest(null, null, null, null, null, null, null, occurredAt);
    when(repo.save(existing)).thenReturn(existing);

    TransactionEntity updated = service.update(existing, req);

    assertEquals(LocalDate.of(2026, 1, 31), updated.getOccurredOn());
  ...
  void list_firstPage_returnsRows_andGeneratesNextCursorWhenMoreThanPageSize() {
    ...
    TransactionEntity r1 =
        tx(
            UUID.fromString("10000000-0000-0000-0000-000000000001"),
            LocalDate.of(2026, 1, 10),
            OffsetDateTime.parse("2026-01-10T10:00:00Z"));
    TransactionEntity r2 =
        tx(
            UUID.fromString("10000000-0000-0000-0000-000000000002"),
            LocalDate.of(2026, 1, 9),
            OffsetDateTime.parse("2026-01-09T10:00:00Z"));
    TransactionEntity r3 =
        tx(
            UUID.fromString("10000000-0000-0000-0000-000000000003"),
            LocalDate.of(2026, 1, 8),
            OffsetDateTime.parse("2026-01-08T10:00:00Z"));
    ...
    TransactionListFilter f =
        new TransactionListFilter(
            bookId, null, null, null, null, null, limit, null, null, null, null);
  ...
  void list_afterCursor_usesAfterCursorRepoMethod() {
    ...
    TransactionListFilter seed =
        new TransactionListFilter(bookId, null, null, null, null, null, 2, null, null, null, null);
    ...
    TransactionListFilter f =
        new TransactionListFilter(
            bookId, null, null, null, null, null, limit, cursor, null, null, null);
    CursorPage<TransactionEntity> page = service.list(f);
  ...
  void list_throwsBadRequest_whenCursorInvalid() {
    TransactionListFilter f =
        new TransactionListFilter(
            bookId, null, null, null, null, null, 50, "not-base64", null, null, null);
