...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleMissingParameter(
    ...
    log.warn("Missing request parameter: name={}", ex.getParameterName());
    return ResponseEntity.badRequest()
        .body(
            error(
                "VALIDATION_ERROR",
  ...
  public ResponseEntity<ErrorResponse> handleDateTimeParse(DateTimeParseException ex) {
    log.warn("Invalid date request parameter: value={}", ex.getParsedString());
    return ResponseEntity.badRequest()
        .body(
            error(
                "VALIDATION_ERROR",
  ...
  public ResponseEntity<ErrorResponse> handleUnknown(Exception ex, HttpServletRequest request) {
    log.error(
        "Unexpected error in request: path={}, method={}",
  ...
  private ErrorResponse error(String code, String message, List<? extends Map<String, ?>> details) {
    ...
    return new ErrorResponse(
        new ErrorResponse.Error(code, message, details == null ? List.of() : details, requestId));
  }
